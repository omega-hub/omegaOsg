if(WIN32)
    if(OMEGA_TOOL_VS12)
        ...
        set(EXTLIB_NAME fbxsdk_win-2014-vs12)
    endif()
...
if(NOT EXISTS ${EXTLIB_DIR})
	...
	if(APPLE)
        ...
        if(OMEGA_TOOL_VS12)
            # url to VS2013 FBX SDK uploaded on Alessandro Febretti's google drive
            # NOTE: this is just preparatory work, since it appears the FBX sdk does not yet support visual studio 2013.
            file(DOWNLOAD https://drive.google.com/uc?export=download&confirm=lIBi&id=0B1_aR21vu6SEUGplVUtaZTBKU2c ${EXTLIB_TGZ} SHOW_PROGRESS)
        else()
