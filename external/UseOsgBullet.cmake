...
if(WIN32)
    ...
    set(OSGBULLET_ARGS
        ...
        -DCMAKE_ARCHIVE_OUTPUT_DIRECTORY_DEBUG:PATH=${OSGBULLET_LIB_DIR}/Debug
        -DCMAKE_ARCHIVE_OUTPUT_DIRECTORY_RELEASE:PATH=${OSGBULLET_LIB_DIR}/Release
        #Bullet
...
elseif(APPLE)
    set(OSGBULLET_ARGS
        ...
        #Bullet
        -DCMAKE_RUNTIME_OUTPUT_DIRECTORY:PATH=${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/osg/osgPlugins-${OSG_VERSION}
...
elseif(APPLE)
    foreach( C ${OSGBULLET_COMPONENTS} )
            ...
            set(${C}_LIBRARY_DEBUG ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/lib${C}.dylib)
            set(OSGBULLET_LIBRARIES ${OSGBULLET_LIBRARIES} optimized ${${C}_LIBRARY} debug ${${C}_LIBRARY_DEBUG})
    endforeach()
else()
    foreach( C ${OSGBULLET_COMPONENTS} )
            set(${C}_LIBRARY ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/lib${C}.so)
            set(${C}_LIBRARY_DEBUG ${CMAKE_RUNTIME_OUTPUT_DIRECTORY}/lib${C}.so)
            set(OSGBULLET_LIBRARIES ${OSGBULLET_LIBRARIES} optimized ${${C}_LIBRARY} debug ${${C}_LIBRARY_DEBUG})
    endforeach()
endif()
